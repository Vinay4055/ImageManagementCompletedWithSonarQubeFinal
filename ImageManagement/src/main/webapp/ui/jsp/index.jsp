				...
				<tr>
					...
					<form method="POST" action="/project/upload"
						...
						&nbsp;&nbsp;&nbsp; <input type="submit" value="Submit"
							style="padding-right: 2px;" /> ${ImageSizeExceed } <br>
						${TotalImageSizeExceed } <br> ${exception }
					</form>
				...
				<table>
					...
					<c:forEach var="object" items="${ images }" varStatus="loop">
						...
						<tr id='image${count }'>
							...
							<td><img alt="Image"
								src="data:image/jpg;base64,${object.base64Image}" width="100"
								height="150" /></td>
							<td style="width: 100px"><form:form
									action="/project/updateImage" method="POST">
								...
								</form:form> <form:form action="/project/deleteImage" method="POST">
									<input type="hidden" name="imageId" value="${ object.imageId }">
